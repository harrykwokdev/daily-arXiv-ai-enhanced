...
### [10] [AdaVFM: Adaptive Vision Foundation Models for Edge Intelligence via LLM-Guided Execution](https://arxiv.org/abs/2604.15622)
...
### [11] [SIMMER: Cross-Modal Food Image--Recipe Retrieval via MLLM-Based Embedding](https://arxiv.org/abs/2604.15628)
...
### [12] [Causal Bootstrapped Alignment for Unsupervised Video-Based Visible-Infrared Person Re-Identification](https://arxiv.org/abs/2604.15631)
...
### [13] [SPLIT: Self-supervised Partitioning for Learned Inversion in Nonlinear Tomography](https://arxiv.org/abs/2604.15651)
...
### [14] [Towards Realistic Open-Vocabulary Remote Sensing Segmentation: Benchmark and Baseline](https://arxiv.org/abs/2604.15652)
...
### [15] [From Zero to Detail: A Progressive Spectral Decoupling Paradigm for UHD Image Restoration with New Benchmark](https://arxiv.org/abs/2604.15654)
...
### [16] [CPU Optimization of a Monocular 3D Biomechanics Pipeline for Low-Resource Deployment](https://arxiv.org/abs/2604.15665)
...
### [17] [PixDLM: A Dual-Path Multimodal Language Model for UAV Reasoning Segmentation](https://arxiv.org/abs/2604.15670)
...
### [18] [HyCal: A Training-Free Prototype Calibration Method for Cross-Discipline Few-Shot Class-Incremental Learning](https://arxiv.org/abs/2604.15678)
...
### [19] [Self-Supervised Angular Deblurring in Photoacoustic Reconstruction via Noisier2Inverse](https://arxiv.org/abs/2604.15681)
...
### [20] [P3T: Prototypical Point-level Prompt Tuning with Enhanced Generalization for 3D Vision-Language Models](https://arxiv.org/abs/2604.15703)
...
### [136] [Can a Weaker Player Win? Adaptive Play in Repeated Games](https://arxiv.org/abs/2604.15315)
...
### [137] [The Power of Information for Intermediate States in Contract Design](https://arxiv.org/abs/2604.15636)
...
### [138] [The Price of Paranoia: Robust Risk-Sensitive Cooperation in Non-Stationary Multi-Agent Reinforcement Learning](https://arxiv.org/abs/2604.15695)
...
### [139] [Why Open Source? A Game-Theoretic Analysis of the AI Race](https://arxiv.org/abs/2604.16227)
...
### [140] [A shifted interface approach for internal discontinuities in poroelastic media](https://arxiv.org/abs/2604.15450)
...
### [141] [When structure does not imply symmetry](https://arxiv.org/abs/2604.15682)
...
### [142] [Divide and Truncate: A Penetration and Inversion Free Framework for Coupled Multi-physics Systems](https://arxiv.org/abs/2604.15513)
...
### [143] [DeepER-Med: Advancing Deep Evidence-Based Research in Medicine Through Agentic AI](https://arxiv.org/abs/2604.15456)
...
### [144] [GIST: Multimodal Knowledge Extraction and Spatial Grounding via Intelligent Semantic Topology](https://arxiv.org/abs/2604.15495)
...
### [145] [Bureaucratic Silences: What the Canadian AI Register Reveals, Omits, and Obscures](https://arxiv.org/abs/2604.15514)
...
### [146] [LACE: Lattice Attention for Cross-thread Exploration](https://arxiv.org/abs/2604.15529)
...
### [148] [KWBench: Measuring Unprompted Problem Recognition in Knowledge Work](https://arxiv.org/abs/2604.15760)
*Ankit Maloo*
...
### [150] [Bilevel Optimization of Agent Skills via Monte Carlo Tree Search](https://arxiv.org/abs/2604.15709)
...
### [151] [The World Leaks the Future: Harness Evolution for Future Prediction Agents](https://arxiv.org/abs/2604.15719)
...
### [152] [LLM Reasoning Is Latent, Not the Chain of Thought](https://arxiv.org/abs/2604.15726)
*Wenshuo Wang*
...
### [153] [Structured Abductive-Deductive-Inductive Reasoning for LLMs via Algebraic Invariants](https://arxiv.org/abs/2604.15727)
...
### [154] [Stein Variational Black-Box Combinatorial Optimization](https://arxiv.org/abs/2604.15837)
...
### [156] [Experience Compression Spectrum: Unifying Memory, Skills, and Rules in LLM Agents](https://arxiv.org/abs/2604.15877)
...
### [157] [Towards Rigorous Explainability by Feature Attribution](https://arxiv.org/abs/2604.15898)
...
### [158] [Integrating Graphs, Large Language Models, and Agents: Reasoning and Retrieval](https://arxiv.org/abs/2604.15951)
...
### [160] [ReactBench: A Benchmark for Topological Reasoning in MLLMs on Chemical Reaction Diagrams](https://arxiv.org/abs/2604.15994)
...
### [161] [MEDLEY-BENCH: Scale Buys Evaluation but Not Control in AI Metacognition](https://arxiv.org/abs/2604.16009)
...
### [162] [SocialGrid: A Benchmark for Planning and Social Reasoning in Embodied Multi-Agent Systems](https://arxiv.org/abs/2604.16022)
...
### [163] [MARCH: Multi-Agent Radiology Clinical Hierarchy for CT Report Generation](https://arxiv.org/abs/2604.16175)
...
### [164] [Characterising LLM-Generated Competency Questions: a Cross-Domain Empirical Study using Open and Closed Models](https://arxiv.org/abs/2604.16258)
...
### [165] [Learning to Reason with Insight for Informal Theorem Proving](https://arxiv.org/abs/2604.16278)
...
### [166] [Using Large Language Models and Knowledge Graphs to Improve the Interpretability of Machine Learning Models in Manufacturing](https://arxiv.org/abs/2604.16280)
...
### [167] [Robust Transmission Design for RIS-Assisted High-Speed Train Communication Coverage Enhancement With Imperfect Cascaded Channels](https://arxiv.org/abs/2604.15387)
...
### [168] [Five Constructions of Asymptotically Optimal Aperiodic Doppler Resilient Complementary Sequence Sets with New Parameters](https://arxiv.org/abs/2604.15403)
...
### [169] [Lossless Compression via Chained Lightweight Neural Predictors with Information Inheritance](https://arxiv.org/abs/2604.15472)
...
### [170] [Rate-Distortion Theory for Deductive Sources under Closure Fidelity](https://arxiv.org/abs/2604.15698)
*Jianfeng Xu*
...
### [171] [Adaptive Power Allocation and User Scheduling for LEO Satellites using Channel Predictions](https://arxiv.org/abs/2604.15733)
...
### [172] [Optimization of Sparse VLSF Codes for Short-Packet Transmission via Saddlepoint Methods](https://arxiv.org/abs/2604.16049)
...
### [173] [VLSF Decoding with Reliability Guarantees over Correlated Noncoherent Fading Channels](https://arxiv.org/abs/2604.16062)
*Guodong Sun,Samir M. Perlaza,Philippe Mary,Jean-Marie Gorce*
...
### [174] [Decoding Algorithms for Tensor Codes](https://arxiv.org/abs/2604.16105)
